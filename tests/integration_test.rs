// use tp_individual::ajedrez::{inicializar_piezas, comenzar_juego, jugar_ajedrez};
// mod model;
// use model::color::Resultado;
...
//     let piezas = inicializar_piezas(&String::from("dimension_invalida.txt")).unwrap_error();
