...
impl Pieza {
    ...
    fn puede_capturar_diagonal(&self, casilla_1: &Casilla, casilla_2: &Casilla) -> bool{
        (casilla_1.fila - casilla_2.fila).abs() 
        == (casilla_1.columna - casilla_2.columna).abs()
    }

    fn puede_capturar_recta(&self, casilla_1: &Casilla, casilla_2: &Casilla) -> bool{
        casilla_1.fila == casilla_2.fila 
        || casilla_1.columna == casilla_2.columna
    }
    ...
    fn puede_capturar_l(&self, casilla_1: &Casilla, casilla_2: &Casilla) -> bool{
        ...
        (dif_fila == 1 && dif_col == 2) ||
        (dif_fila == 2 && dif_col == 1)
    }

    fn puede_capturar_peon(&self, casilla_1: &Casilla, casilla_2: &Casilla, color_peon: &Color) -> bool{
